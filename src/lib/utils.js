...
export const lyrics = [
  ...
  { time: 7.7, text: "I" },
  { time: 8.9, text: "I just woke up" },
  { time: 9.1, text: "from a dream" },
  { time: 13.9, text: "Where you and I" },
  { time: 15.0, text: "had to say goodbye" },
  { time: 19.5, text: "And I don't know" },
  { time: 20.8, text: "what it all means" },
  { time: 23.9, text: "But since I survived" },
  { time: 24.8, text: "I realized" },
  { time: 27.5, text: "Wherever you go" },
  { time: 28.8, text: "that's where I'll follow" },
  { time: 33.367, text: "Nobody's" },
  { time: 33.9, text: "promised tomorrow" },
  { time: 37.997, text: "So I'mma love you every night" },
  { time: 40.2, text: "like it's the last night" },
  { time: 42.042, text: "Like it's the last night" },
  { time: 44.211, text: "If the world was ending" },
  { time: 46.5, text: "I'd wanna be next to you" },
  { time: 53.179, text: "If the party was over" },
  { time: 46.5, text: "I'd wanna be next to you" },
  { time: 53.179, text: "If the party was over" },
  { time: 55.5, text: "and our time on Earth was through" },
  ...
  { time: 124.1, text: "I'd wanna be next to you" },
